...
$ffi->load_custom_type('::Enum',
    keyboardkey_t => map { [ $_->key, $_->value ] } pairs
        KEY_NULL          => 0,
        KEY_APOSTROPHE    => 39,
        KEY_COMMA         => 44,
        KEY_MINUS         => 45,
...
# GetWindowHandle         => [ []                   => 'void' ], # not at all sure how to handle this yet
    ...
    IsKeyPressed       => [ ['keyboardkey_t'] => 'bool' ],
    IsKeyPressedRepeat => [ ['keyboardkey_t'] => 'bool' ],
    IsKeyDown          => [ ['keyboardkey_t'] => 'bool' ],
    IsKeyReleased      => [ ['keyboardkey_t'] => 'bool' ],
    IsKeyUp            => [ ['keyboardkey_t'] => 'bool' ],
    GetKeyPressed      => [ []      => 'keyboardkey_t' ],
    GetCharPressed     => [ []      => 'int' ],
    SetExitKey         => [ ['keyboardkey_t'] => 'void' ],
